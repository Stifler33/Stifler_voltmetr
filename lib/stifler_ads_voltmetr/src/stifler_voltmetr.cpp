...
bool Stifler_voltmetr::begin(uint8_t channel, uint8_t pin_error, uint8_t i2c_address, TwoWire *wire){
    this->channel = channel;    
    this->pin_error = pin_error;
...
float Stifler_voltmetr::read_voltage(){
    int raw_voltage = readADC_SingleEnded(channel);
